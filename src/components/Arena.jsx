...
function Bombs({ bombs, tile }) {
  return (bombs || []).flatMap((bomb) => {
    ...
    return (
      <div
        key={bomb.id}
        className="absolute z-[5] animate-bomb-pulse bg-[url('/assets/imgs/bomb.png')] bg-contain bg-center bg-no-repeat"
...
export default function Arena({ gameState, myId, compactBottom = false }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="relative overflow-hidden border-2 border-[#212529] bg-white"
